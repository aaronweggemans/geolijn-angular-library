...
describe('latitudeLongitudeCasting', () => {
  ...
  describe('Punt 1D', () => {
    ...
    const australia = [-33.86882, 151.209296];
    ...
    it('should transform the australian coordinates in 1D', () => {
      ...
      expect(transform).toStrictEqual([151.209296, -33.86882]);
    });
  });
  ...
  describe('Multipolygon with enclaves', () => {
    const gemeenteVeere = [
      [
        [
          [3.718797312749321, 51.65033140866423],
          [3.718797312749321, 51.65033140866423],
        ],
      ],
      [
        [
          [3.683207765764666, 51.600786050677954],
          [3.683207765764666, 51.600786050677954],
        ],
      ],
      [
        [
          [3.63362562331464, 51.589339743688036],
          [3.629744818092722, 51.58958079615639],
          [3.629814183119434, 51.58835369820563],
          [3.63362562331464, 51.589339743688036],
        ],
      ],
      [
        [
          [3.70133364273185, 51.6439884451799],
          [3.697230380850813, 51.64130048153025],
          [3.70133364273185, 51.6439884451799],
        ],
      ],
      [
        [
          [3.681674108832073, 51.61742861324761],
          [3.681674108832073, 51.61742861324761],
        ],
      ],
    ];
    ...
    it('should transform the enclave coordinates', () => {
      ...
      expect(transform).toStrictEqual([
        [
          [
            [51.65033140866423, 3.718797312749321],
            [51.65033140866423, 3.718797312749321],
          ],
        ],
        [
          [
            [51.600786050677954, 3.683207765764666],
            [51.600786050677954, 3.683207765764666],
          ],
        ],
        [
          [
            [51.589339743688036, 3.63362562331464],
            [51.58958079615639, 3.629744818092722],
            [51.58835369820563, 3.629814183119434],
            [51.589339743688036, 3.63362562331464],
          ],
        ],
        [
          [
            [51.6439884451799, 3.70133364273185],
            [51.64130048153025, 3.697230380850813],
            [51.6439884451799, 3.70133364273185],
          ],
        ],
        [
          [
            [51.61742861324761, 3.681674108832073],
            [51.61742861324761, 3.681674108832073],
          ],
        ],
      ]);
